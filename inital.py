    ...
    if len(lines) != 0: 
        for line in lines: 
            ...
            if(y1 >= eye_avg and y2 >= eye_avg): # only show lines under eyes
                cv2.line(img, (x1,y1), (x2, y2), (255,255,255),3) # Drawing all houglines
        ...
        if labels_dict[label] == "mask":
            ...
            with tf.Session(config=sess_config) as sess:
                ...
                for var in vars_list:
                    vname = var.name
                    from_name = vname
                    var_value = tf.contrib.framework.load_variable('C:/Users/adris/Desktop/generative_inpainting/model_logs/release_celeba_hq_256_deepfill_v2', from_name)
